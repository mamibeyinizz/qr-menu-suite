...
function qrms_cs_color_fields() {
	return array(
		'bg'       => array(
			'label'    => __( 'Liste arka planı', 'qrms' ),
			'desc'     => __( 'Boş bırakılırsa sayfanın rengi görünür.', 'qrms' ),
			'fallback' => 'transparent',
			'var'      => '--qrms-cs-bg',
		),
		'border'   => array(
			'label'    => __( 'Kenarlık rengi', 'qrms' ),
			'desc'     => __( 'Boş bırakılırsa çerçeve çizilmez.', 'qrms' ),
			'fallback' => '',
			'var'      => '--qrms-cs-border',
		),
		'text'     => array(
			'label'    => __( 'Genel yazı rengi', 'qrms' ),
			'desc'     => __( 'Ayrı renk seçilmeyen tüm metinler bunu kullanır.', 'qrms' ),
			'fallback' => '',
			'var'      => '--qrms-cs-text',
		),
		'today'    => array(
			'label'    => __( 'Bugünün vurgu rengi', 'qrms' ),
			'desc'     => __( 'İçinde bulunulan günün adı ve saati.', 'qrms' ),
			'fallback' => '#c9a84c',
			'var'      => '--qrms-cs-today',
		),
		'today_bg' => array(
			'label'    => __( 'Bugünün satır arka planı', 'qrms' ),
			'desc'     => __( 'Boş bırakılırsa zemin olmaz.', 'qrms' ),
			'fallback' => 'transparent',
			'var'      => '--qrms-cs-today-bg',
		),
		'day'      => array(
			'label'    => __( 'Gün adı rengi', 'qrms' ),
			'desc'     => __( 'Boş bırakılırsa genel yazı rengi kullanılır.', 'qrms' ),
			'fallback' => '',
			'var'      => '--qrms-cs-day',
		),
		'hours'    => array(
			'label'    => __( 'Saat metni rengi', 'qrms' ),
			'desc'     => __( 'Boş bırakılırsa genel yazı rengi kullanılır.', 'qrms' ),
			'fallback' => '',
			'var'      => '--qrms-cs-hours',
		),
		'closed'   => array(
			'label'    => __( 'Kapalı gün rengi', 'qrms' ),
			'desc'     => __( '"Kapalı" yazan satırlar.', 'qrms' ),
			'fallback' => '',
			'var'      => '--qrms-cs-closed',
		),
		'divider'  => array(
			'label'    => __( 'Satır ayırıcı rengi', 'qrms' ),
