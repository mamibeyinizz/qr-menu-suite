...
trait RMA_Kampanya_Admin_Trait {
    ...
    /** Banner görünüm formunun nonce eylemi (= admin_post eylemi). */
     ...
     * menüde görünmez; erişim bu bölümden verilir. Kampanya görselleri
     * kampanyalarla birlikte yönetilsin diye bu ekranda durur (önceden
     * Öne Çıkanlar sayfasındaydı).
     */
    private function render_banner_section() {
        ...
        <div class="rma-card" id="rma-banner">
            ...
            <p class="rma-actions">
                ...
                <a class="button" href="<?php echo esc_url( $this->admin_page_url( 'qrms-rm-banner-ayar' ) ); ?>">Banner Görünümü</a>
            </p>
        </div>
        <?php
    }
    ...
    /* -----------------------------------------------------------------
       ...
       Sihirbaz, Öne Çıkan Slider görünüm formuyla aynı yapıyı kullanır;
       canlı önizleme ön yüzün GERÇEK frontend-banner-slider.css'ini
       kullanır, sahte bir önizleme stili yoktur.
    ----------------------------------------------------------------- */
    ...
    public function handle_banner_settings_save() {
        ...
        wp_safe_redirect(
            add_query_arg(
                array(
                    'page'       => 'qrms-rm-banner-ayar',
                    'banner_msg' => 'kaydedildi',
                ),
                admin_url( 'admin.php' )
            )
        );
    ...
    /**
     * Banner görünüm kaydı sonrası bildirimi basar.
     *
     * @return void
     */
    private function banner_notice() {
        ...
        echo '<div class="notice notice-success is-dismissible"><p>Banner görünümü kaydedildi.</p></div>';
    }
    ...
    /**
     * Kampanya Banner görünüm sihirbazı — oran, geçiş, oklar ve başlık.
     *
     * @return void
     */
    public function render_banner_settings_page() {
        $this->page_header(
            'Banner Görünümü',
            'Sayfanın en üstündeki kampanya banner\'ının nasıl görüneceğini buradan ayarlayın. Banner görsellerinin kendisi Fiyat Kampanyaları ekranından yönetilir.'
        );

        $this->banner_notice();

        if ( ! class_exists( 'QMO_Banner_Slider_Settings' ) ) {
            echo '<div class="rma-card"><p class="rma-empty">Banner modülü yüklü değil.</p></div>';
            $this->page_footer();
            return;
        }
        ...
        <form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>" id="qmo-banner-form">
            ...
            <div class="rma-vitrin-steps" id="qmo-banner-steps" role="tablist" aria-label="Banner görünüm adımları">
            ...
            <div class="rma-vitrin-layout-wrap">
                <div class="rma-vitrin-layout-fields">
                    ...
                    <div class="rma-card rma-vitrin-step" data-step="2" data-step-title="Oklar, Noktalar ve Otomatik Geçiş" style="display:none;">
                        ...
                        <p class="rma-card-desc">Ziyaretçinin banner'lar arasında nasıl geçeceğini belirleyin. Tek banner varken ok ve noktalar zaten basılmaz.</p>
                        ...
                        <table class="form-table rma-form-table">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description rma-desc">Kaç banner olduğunu ve hangisinde olunduğunu gösterir.</p>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <p class="description rma-desc">Bir banner ekranda ne kadar bekleyecek. Kısa koda <code>autoplay="0"</code> yazılırsa o sayfada bu ayar ezilir.</p>
                                </td>
                            </tr>
                        </table>
                    </div>
                    ...
                    <div class="rma-card rma-vitrin-step" data-step="3" data-step-title="Banner Başlığı" style="display:none;">
                        ...
                        <p class="rma-card-desc">Görselin üstüne binen başlık, banner kaydının adıdır. Yazı tipi ve renk tüm cihazlarda ortaktır; punto masaüstü ve mobil için ayrı ayarlanır.</p>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <label class="rma-check-row">
                                        ...
                                        <span>Banner başlığını görselin üstünde göster</span>
                                    </label>
                ...
                <div class="rma-vitrin-layout-preview">
                    <div class="rma-card rma-vitrin-preview-card">
                        ...
                        <p class="rma-card-desc">Soldaki her değişiklik anında yansır. <?php echo '' === $onizleme_gorsel ? 'Henüz görselli bir banner yok; yer tutucu gösteriliyor.' : 'Yayındaki ilk banner görseliniz kullanılıyor.'; ?></p>
