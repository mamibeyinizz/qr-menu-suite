	...
	wp_localize_script(
		...
		array(
			...
			'i18n'              => array(
				...
				'cardTables'     => __( 'Aktif Masa Sayısı', 'qrms' ),
				'cardTablesSub2' => __( 'Seçili aralıkta en az bir hareket (görüntüleme/tıklama) olan masa sayısı', 'qrms' ),
	...
	wp_localize_script(
		...
		array(
			...
			'i18n'          => array(
				...
				'cardRevenue'       => __( 'Ciro', 'qrms' ),
				'cardAov'           => __( 'Ortalama sepet tutarı', 'qrms' ),
				'cardPending'       => __( 'Sepette bekleyen tutar', 'qrms' ),
				'cardMissedRevenue' => __( 'Kaçan ciro', 'qrms' ),
				'revenueNote'       => __( 'Gönderilen siparişler, taban fiyat üzerinden', 'qrms' ),
				'aovNote'           => __( 'Ciro / gönderilen sipariş oturumu', 'qrms' ),
				'pendingNote'       => __( 'Sepete konan (henüz sipariş olmamış dahil)', 'qrms' ),
				'missedRevenueNote' => __( 'Tükendi nedeniyle engellenen siparişler', 'qrms' ),
				'missedRevenue'     => __( 'Kaçan ciro', 'qrms' ),
				'revenue'           => __( 'Ciro', 'qrms' ),
				'unitsSold'         => __( 'Satılan adet', 'qrms' ),
				'noRevenue'         => __( 'Bu aralıkta gönderilmiş sipariş yok.', 'qrms' ),
				'funnelView'        => __( 'Menü görüntüleme', 'qrms' ),
				'funnelClick'       => __( 'Ürün tıklama', 'qrms' ),
				'funnelCart'        => __( 'Sepete ekleme', 'qrms' ),
				'funnelOrder'       => __( 'Sipariş', 'qrms' ),
				'events'             => __( 'olay', 'qrms' ),
				...
				'groupVolume'       => __( 'Hacim', 'qrms' ),
				'groupOrders'       => __( 'Sipariş', 'qrms' ),
				'groupMoney'        => __( 'Para', 'qrms' ),
				'emptyNone'         => __( 'Veri yok', 'qrms' ),
				'emptyWhy'          => __( 'neden?', 'qrms' ),
