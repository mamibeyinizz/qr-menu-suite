	...
	function rma_ceviri_modul_kaynak_metinleri() {
		$katalog = array(
			...
			'review'  => array(
				...
				'En fazla %1$d görsel, dosya başına %2$d MB. JPEG, PNG veya WebP.',
				'Geçersiz dosya yüklemesi.',
				'Dosya yüklenemedi.',
				'Dosya boyutu sınırı aşıldı.',
				'Yalnızca JPEG, PNG veya WebP görseller kabul edilir.',
				'Görsel kaydedilemedi.',
				'Geçersiz yorum.',
				'En fazla %d görsel yükleyebilirsiniz.',
