...
function qrms_mm_ayarlar_sayfasi() {
	...
	<div class="wrap qrms-wrap qrms-mm">
		<h1 class="qrms-title"<?php echo QRMS_Admin_Shell::duplicate_page_title_a11y_attr(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php esc_html_e( 'Menü Performansı Ayarları', 'qrms' ); ?></h1>
