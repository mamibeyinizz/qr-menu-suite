...
qrms_test(
	'buton iç boşluğu CSS değişkenine basılır ve 0 geçerlidir',
	function () {
		$GLOBALS['qrms_test']['is_front_page'] = true;
		...
		qrms_assert_contains( '--sp-cta-pad: 8px 22px', $html, 'padding CSS\'e basılır' );
		...
		qrms_assert_contains( '--sp-cta-pad: 0px 0px', ob_get_clean(), 'sıfır padding varsayılana düşmez' );
		qrms_assert_same( '0px 0px', get_option( 'splash_screen_options' )['button_padding'], 'option 0 saklar' );
	}
);
