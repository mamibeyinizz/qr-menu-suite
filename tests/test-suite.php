...
qrms_test(
	...
	function () {
		...
		qrms_assert_contains( 'flush_page_caches', $kayit, 'kaydet sonrası önbellek temizliği' );
		qrms_assert_contains( "function_exists( 'qmo_tum_onbellek_temizle' )", $kayit, 'qmo_tum_onbellek_temizle varsa çağrılır' );
		qrms_assert_contains( "function_exists( 'rocket_clean_domain' )", $kayit, 'WP Rocket temizliği' );
	}
);
