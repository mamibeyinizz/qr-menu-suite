...
class QRMS_Shortcodes {
	...
	public static function render_page() {
		...
		<div class="wrap qrms-hub qrms-sc">
			<h1 class="qrms-hub-heading"<?php echo QRMS_Admin_Shell::duplicate_page_title_a11y_attr(); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>><?php esc_html_e( 'Entegrasyonlar & Kısa Kodlar', 'qrms' ); ?></h1>
